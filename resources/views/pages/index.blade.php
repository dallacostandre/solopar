...
<main>
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <p data-animation="fadeInLeft" data-delay="0.4s">{{__('messages.home-title-description')}}</p>
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">{{__('messages.contact-home')}} <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>          
                    ...
                    <div class="single-gallery text-center">
                        ...
                        <div class="thumb-content-box">
                            <div class="thumb-content">
                                ...
                                <a href="services.html">{{__('messages.get-to-know-more')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-8 col-lg-9 col-md-8">
                        <div class="wantToWork-caption wantToWork-caption2">
                            <h2>{{__('messages.quote')}}</h2>
                            <p>{{__('messages.quote-description')}}</p>
                        </div>
                    </div>
    ...
    <section class="Map-area">
        <div class="mapouter"><div class="gmap_canvas"><iframe width="1080" height="530" id="gmap_canvas" src="https://maps.google.com/maps?q=Rua%20Magdalena%20de%20Almeida,%20224%20%20Cap%C3%A3o%20Raso%20%E2%80%93%2081130260%20%E2%80%93%20Curitiba%20%E2%80%93%20PR&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://fmovies-online.net">fmovies</a><br><style>.mapouter{position:relative;text-align:center;height:530px;width:"100%";}</style><a href="https://www.embedgooglemap.net">embedgooglemap.net</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:530px;width:"100%";}</style></div></div>
    </section>
</main>
@endsection
